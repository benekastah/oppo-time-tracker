...
var program_d07u_h5r1skvb = null;


// Oppo runtime
var regex, js_eval, _$if_, cond, lambda, array, object, get_prop, get_fn, _$new_, js_for, foreach, subtract, add, multiply, divide, modulo, _$equals__$equals_, _$equals__$equals__$equals_, gt, lt, gte, lte, not_$equals__$equals__$equals_, not_$equals__$equals_, not, or, and, _$amperstand_, _$pipe_, _$carat_, _$leftangle__$leftangle_, _$rightangle__$rightangle_, _$rightangle__$rightangle__$rightangle_, _$tilde_, _$delete_, keyword, symbol__$rightangle_keyword, include, symbol, def, apply, call, defmacro, _$let_, _$do_, quote, quasiquote, unquote, unquote_splicing, raise, _$try_, assert;
__oppo_runtime_defined__ = true;
identity = function (x) {
          return x;
        };
object_$questionmark_ = function (x) {
  return __typeof__(x) === "object";
};
array_$questionmark_ = function (x) {
  return __typeof__(x) === "array";
};
list_$questionmark_ = function (x) {
          var t;
          t = __typeof__(x);
          return t === "array" || t === "arguments";
        };
number_$questionmark_ = function (x) {
  return __typeof__(x) === "number";
};
string_$questionmark_ = function (x) {
  return __typeof__(x) === "string";
};
boolean_$questionmark_ = function (x) {
  return __typeof__(x) === "boolean";
};
bool_$questionmark_ = boolean_$questionmark_;
regex_$questionmark_ = function (x) {
  return __typeof__(x) === "regexp";
};
date_$questionmark_ = function (x) {
  return __typeof__(x) === "date";
};
nil_$questionmark_ = function (x) {
          var t;
          t = __typeof__(x);
          return t === "null" || t === "undefined";
        };
...
__explicitEnum__ = __hasDontEnumBug__ ? [        'constructor', 'hasOwnProperty', 'isPrototypeOf', 'propertyIsEnumerable',        'toLocaleString', 'toString', 'valueOf'      ] : null;
...
push = function (a) {
    var args = __slice__.call(arguments, 1);
    var new_a = a.slice();
    new_a.push.apply(new_a, args);
    return new_a;
};
push_right = push;
push_r = push;
push_left = function (a) {
    var args = __slice__.call(arguments, 1);
    var new_a = a.slice();
    new_a.unshift.apply(new_a, args);
    return new_a;
};
push_l = push_left;
rest = function (a) {
...
empty_$questionmark_ = function (c) {
          return (count(c)) === 0;
        };
contains_$questionmark_ = function (c, v) {
          var k, x, _i, _len, _ref3;
          if ((_ref3 = __typeof__(c)) === "array" || _ref3 === "arguments") {
            for (_i = 0, _len = c.length; _i < _len; _i++) {
              x = c[_i];
...
contains_key_$questionmark_ = function (c, k) {
          return k in c;
        };
map = function (f, o) {
          var k, result, t, v, x, _i, _len, _results;
...
re_test = function (re, s) {
          return re.test(s);
        };

// Run the oppo program
if (lemur.core.to_type(program_d07u_h5r1skvb) === 'function')
  program_d07u_h5r1skvb();
else
  program_d07u_h5r1skvb;;// Your program
var program_22re_h5r1sktw = function () {
...
seconds = _$forwardslash_(n, 1000);
  minutes = _$forwardslash_(seconds, 60);
  hours = _$forwardslash_(minutes, 60);
  ...
  return (function () {
  var el, row, time_in, time_out, _$in_, out, obj_4uwl_h5r1sku3;
el = $(this);
  ...
  ((time_in.add)(time_out).attr)((obj_4uwl_h5r1sku3 = { 'contenteditable': true }, obj_4uwl_h5r1sku3));
  (time_in.html)(_$in_);
...
el = $(this);
  ...
  return (function () {
  var really_$questionmark_, el, row, id;
really_$questionmark_ = confirm('Are you sure you want to delete this entry? This cannot be undone.');
  el = $(this);
  row = (el.parents)('tr:first');
  id = (row.data)('id');
  return (really_$questionmark_ ? ($.post)(concat('/delete-timestamps/', id), reload) : null);
}).call(this);
};
  create_project = function (evt) {
  return (function () {
  var project_name;
project_name = prompt('Name your project:');
  return ($.post)(concat('/create-project/', project_name), reload);
}).call(this);
};
  delete_project = function (evt) {
  return (function () {
  var really_$questionmark_, el, id;
really_$questionmark_ = confirm('Are you sure you want to delete this project? This cannot be undone.');
  el = $(this);
  id = (el.data)('id');
...
time_in_out = $('.time-in, .time-out');
  (time_in_out.each)(function (index, el) {
  return (function () {
  var d, $el;
d = ('innerHTML')(el);
  $el = $(el);
  (d ? (($el.html)(display_date(d)), ($el.attr)('data-value', d)) : null);
  return null;
}).call(this);
});
  time_spent = $('.total-time-spent');
  (time_spent.each)(function () {
  return (function () {
  var el;
el = $(this);
  ...
  ($('.cancel-edits').click)(reload);
  ($('#create-project').click)(create_project);
  return ($('button.delete-project').click)(delete_project);
});
};
...
// Run the oppo program
if (lemur.core.to_type(program_22re_h5r1sktw) === 'function')
  program_22re_h5r1sktw();
else
  program_22re_h5r1sktw;